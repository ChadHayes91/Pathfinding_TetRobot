...
* Finally, normalize $$T$$ and multiply it by the scalar $$\big(\|HF\| * c \big) \underline{T} = K$$; $$c$$ is a constant we've found to make the leg a reasonable length (its $$\approx$$ 0.4)
